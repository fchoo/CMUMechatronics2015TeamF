...
// Tabs
	...
	$("ul.tabs li:first-child").addClass("tab-active").show(); //Activate first tab
...
// Tabs-SI
	$(".tab-si_container").hide(); //Hide all content
	$("ul.tabs-si li:first-child").addClass("tab-si-active").show(); //Activate first tab
	$(".tab-si_container:first").show(); //Show first tab content
	$("ul.tabs-si li").click(function() {
			$("ul.tabs-si li").removeClass("tab-si-active"); //Remove any "active" class
			$(this).addClass("tab-si-active"); //Add "active" class to selected tab
			$(".tab-si_container").hide(); //Hide all tab content
			var activeTab = $(this).find("a").attr("href"); //Find the rel attribute value to identify the active tab + content
			$(activeTab).fadeIn(); //Fade in the active content
			return false;
	});
...
// Folders
	$(".folder_container").hide(); //Show first tab content
	$("ul.folders li:first-child").addClass("folder-active").show(); //Activate first tab
	$(".folder_container:first").show(); //Show first tab content
	$("ul.folders li").click(function() {
			$("ul.folders li").removeClass("folder-active"); //Remove any "active" class
			$(this).addClass("folder-active"); //Add "active" class to selected tab
			$(".folder_container").hide(); //Show first tab content
			var activeFolder = $(this).find("a").attr("href"); //Find the rel attribute value to identify the active tab + content
			$(activeFolder).fadeIn(); //Fade in the active content
			return false;
	});
